...
# Choice '2' convert Brix to SG
	if choice == "2":
		while True:
			try:
				brix = float(input("Please input the wort Brix: "))
				break
			except ValueError:
...
# Choice '3' convert SG to Brix
		...
		while True:
			try:
				sg = float(input("Please input the wort SG: "))
				break
			except ValueError:
				print("Please enter a number.")
...
# Choice '4' find ABV using OG and FG
		...
		while True:
			try:
				og = float(input("Please input the OG: "))
				break
			except ValueError:
				print("Please enter a number.")
		while True:
			try:
				fg = float(input("Please input the FG: "))
				break
			except ValueError:
				print("Please enter a number.")
